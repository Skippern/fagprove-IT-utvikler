...
var NfriApi = /** @class */ (function () {
    ...
    Object.defineProperty(NfriApi, "setCredentials", {
        get: function () {
            return function (myCredentials) {
                this.credentials = myCredentials;
                this.headers.set('Authorization', 'Basic ' + btoa("".concat(this.credentials.user, ":").concat(this.credentials.password)));
            };
        },
        enumerable: false,
        configurable: true
